# 025 — Ridge in cloud, right sheet (copy)

Right half of a two-sheet transcription study, in code, of a grainy monochrome diptych: the ridge
itself — a dark spine under cloud, striated rock, the near flank smeared by movement; sheet
[024](../025-ridge-study-left/) holds the other half (the two pictures are one view cut in the middle;
...
- Reading: `../025-ridge-study-left/trace.py` (OpenCV) finds the mat colour and the picture box (900 × 1193 in a
...
- Check (seed 1, vs source): mean abs difference 8.2 / 255 per pixel — at the floor two
  independent grains of this strength allow — and 2.2 / 255 once both are blurred past the grain
