// Ridge in cloud, LEFT sheet — a copy, in code, of the left half of a grainy monochrome diptych
// (cloud bank, a dark hollow, a slope rising to the right edge where the other sheet takes over).
...
// The right sheet is 025; the two share one reading and one engine and meet on this sheet's right edge.
// Keys: R new hand · S save PNG (2× sheet, 2160 × 2700).

let G, SHEETCANVAS, dirty = true;
const TITLE = 'Ridge in cloud — left sheet', FILE = 'ridge-study-left';
